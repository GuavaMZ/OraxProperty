...
part 'ads_apartment_for_rent.g.dart';

@JsonSerializable()
class ApartmentForRentModel {
  ApartmentForRentModel(
      { this.uid,
  ...
  factory ApartmentForRentModel.fromJson(var json) =>
      _$ApartmentForRentModelFromJson(json);
  Map<String, dynamic> toJson() => _$ApartmentForRentModelToJson(this);
}
