...
part 'order_villa_for_rent.g.dart';

@JsonSerializable()
class OrderVillaForRentModel {
  OrderVillaForRentModel(
      {required this.uid,
      ...
      required this.is_air_conditioned,
  ...
  factory OrderVillaForRentModel.fromJson(var json) =>
      _$OrderVillaForRentModelFromJson(json);
  Map<String, dynamic> toJson() => _$OrderVillaForRentModelToJson(this);
}
