...
part 'ads_villa_for_rent.g.dart';

@JsonSerializable()
class AdsVillaForRentModel {
  ...
  factory AdsVillaForRentModel.fromJson(var json) =>
      _$AdsVillaForRentModelFromJson(json);
  Map<String, dynamic> toJson() => _$AdsVillaForRentModelToJson(this);
}
