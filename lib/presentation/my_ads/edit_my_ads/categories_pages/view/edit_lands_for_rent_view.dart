...
import 'package:oraxproperty/presentation/my_ads/edit_my_ads/categories_pages/viewmodel/edit_lands_for_rent_viewmodel.dart';
...
class EditLandsForRentView extends StatefulWidget {
  const EditLandsForRentView({super.key, this.data});
  final Map<String, dynamic>? data;
  @override
  State<EditLandsForRentView> createState() => _LandsForRentViewState();
}

class _LandsForRentViewState extends State<EditLandsForRentView> {
  final EditLandsForRentViewModel _viewModel = EditLandsForRentViewModel();
  @override
  void dispose() {
      ...
      child: Scaffold(
        ...
        body: FutureBuilder(
          ...
          builder: (BuildContext context,AsyncSnapshot snapshot) {
            return Consumer<EditLandsForRentViewModel>(
                            ...
                            child: DropdownButtonHideUnderline(
                              child: ButtonTheme(
                                ...
                                child: DropdownButton(
                                  ...
                                  onChanged: (String? newValue) {
                                    Provider.of<EditLandsForRentViewModel>(context,
                                            listen: false)
