...
import 'package:oraxproperty/presentation/my_ads/edit_my_ads/categories_pages/viewmodel/edit_apartment_for_sale_viewmodel.dart';
...
class EditAppartmentForSaleView extends StatefulWidget {
  const EditAppartmentForSaleView({super.key, this.data});
  final Map<String, dynamic>? data;
  @override
  State<EditAppartmentForSaleView> createState() =>
      _EditAppartmentForSaleViewState();
}

class _EditAppartmentForSaleViewState extends State<EditAppartmentForSaleView> {
  final EditAppartmentForSaleViewModel _viewModel =
      EditAppartmentForSaleViewModel();
  @override
  void dispose() {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
        ...
        child: Scaffold(
            ...
            body: Consumer<EditAppartmentForSaleViewModel>(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        TextContainer(
                          ...
                          text: AppStrings.apartmentForSaleText
                              .getString(context),
                          fontSize: 18,
                    ...
                    children: [
                      for (var element in viewModel.bedroomsQuantity)
                        ChoiceChip(
                          ...
                          elevation: 1,
                          onSelected: (value) {
                            Provider.of<EditAppartmentForSaleViewModel>(context,
                                    listen: false)
