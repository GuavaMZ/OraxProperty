...
import 'package:oraxproperty/presentation/my_ads/edit_my_ads/categories_pages/viewmodel/edit_lands_for_sale_viewmodel.dart';
...
class EditLandsForSaleView extends StatefulWidget {
  const EditLandsForSaleView({super.key, this.data});
  final Map<String, dynamic>? data;
  @override
  State<EditLandsForSaleView> createState() => _LandsForSaleViewState();
}

class _LandsForSaleViewState extends State<EditLandsForSaleView> {
  final EditLandsForSaleViewModel _viewModel = EditLandsForSaleViewModel();
      ...
      child: Scaffold(
        ...
        body: FutureBuilder(
            ...
            builder: (BuildContext context, AsyncSnapshot snapshot) {
              return Consumer<EditLandsForSaleViewModel>(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  TextContainer(
                                    ...
                                    text: AppStrings.landForSaleText
                                        .getString(context),
                                    fontSize: 18,
                                ...
                                child: ButtonTheme(
                                  ...
                                  child: DropdownButton(
                                    ...
                                    onChanged: (String? newValue) {
                                      Provider.of<EditLandsForSaleViewModel>(
                                              context,
                                              listen: false)
                              ...
                              child: ElevatedButton(
                                  onPressed: () async {
                                    viewModel.assignAdValsToConfirmDetailsMap(
                                        context);
                                    print(EditConfirmBeforeSendViewModel
                                        .propertyAdDetails);
                                    bool anyEmpty =
                                        viewModel.checkEmpty(context);
                                    if (anyEmpty != false) {
                                      context.push(
                                          '/edit_my_ads/discription/view',
                                          extra: snapshot.data);
                                    }
                                    // context
