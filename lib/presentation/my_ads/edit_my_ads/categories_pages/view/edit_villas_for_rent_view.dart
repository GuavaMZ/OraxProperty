...
import 'package:oraxproperty/presentation/my_ads/edit_my_ads/categories_pages/viewmodel/edit_villas_for_rent_viewmodel.dart';
...
class EditVillasForRentView extends StatefulWidget {
  const EditVillasForRentView({super.key, this.data});
  final Map<String, dynamic>? data;
  @override
  State<EditVillasForRentView> createState() => _EditVillasForRentViewState();
}

class _EditVillasForRentViewState extends State<EditVillasForRentView> {
  final EditVillasForRentViewModel _viewModel = EditVillasForRentViewModel();
  @override
  void dispose() {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: Scaffold(
        ...
        body: FutureBuilder(
          future: _viewModel.getAdData(widget.data?['ad_id'], widget.data?['category_id']),
          builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              return Consumer<EditVillasForRentViewModel>(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            TextContainer(
                              ...
                              text: AppStrings.villasForRentText
                                  .getString(context),
                              fontSize: 18,
                        ...
                        children: [
                          for (var element in viewModel.rentPayPeriod)
                            ChoiceChip(
                              ...
                              elevation: 1,
                              onSelected: (value) {
                                Provider.of<EditVillasForRentViewModel>(context,
                                        listen: false)
                              ...
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  child: Switch(
                                    ...
                                    onChanged: (b) {
                                      Provider.of<EditVillasForRentViewModel>(
                                              context,
                                              listen: false)
                                          .haveSpecialRoof = b;
                                      viewModel.toggleNotifyListener();
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                            onPressed: () async {
                              ...
                              if (anyEmpty != false) {
                                context.push('/edit_my_ads/discription/view',extra:snapshot.data);
                              }
                            },
