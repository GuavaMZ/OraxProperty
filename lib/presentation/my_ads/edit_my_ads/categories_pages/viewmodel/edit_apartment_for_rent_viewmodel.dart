...
class EditAppartmentForRentViewModel extends ChangeNotifier {
  List adDetails = [];
  assignValues(
      String bedrooms,
      String livingrooms,
    ...
    rentPayPeriodChoice = rentPayPeriod;
  }
  ...
  assignAdValsToConfirmDetailsMap(BuildContext context) async {
    EditConfirmBeforeSendViewModel
        .propertyAdDetails[AppStrings.rentPayPeriodText] = rentPayPeriodChoice;
    EditConfirmBeforeSendViewModel.propertyAdDetails[AppStrings.bedroomText] =
        bedroomsChoice;
    EditConfirmBeforeSendViewModel
        .propertyAdDetails[AppStrings.livingRoomText] = livingRoomChoice;
