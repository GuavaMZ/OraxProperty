...
import 'package:oraxproperty/presentation/add_ad_or_req/categories_pages/viewmodel/lands_for_sale_viewmodel.dart';
...
class LandsForSaleView extends StatefulWidget {
  const LandsForSaleView({super.key});

  @override
  State<LandsForSaleView> createState() => _LandsForSaleViewState();
}

class _LandsForSaleViewState extends State<LandsForSaleView> {
  @override
  void dispose() {
  ...
  final LandsForSaleViewModel _viewModel = LandsForSaleViewModel();
  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: Scaffold(
        ...
        body: Consumer<LandsForSaleViewModel>(
                          ...
                          child: ButtonTheme(
                            ...
                            child: DropdownButton(
                              ...
                              onChanged: (String? newValue) {
                                Provider.of<LandsForSaleViewModel>(context,
                                        listen: false)
