...
import 'package:oraxproperty/presentation/add_ad_or_req/categories_pages/viewmodel/apartment_for_sale_viewmodel.dart';
...
class AppartmentForSaleView extends StatefulWidget {
  const AppartmentForSaleView({super.key});

  @override
  State<AppartmentForSaleView> createState() => _AppartmentForSaleViewState();
}

class _AppartmentForSaleViewState extends State<AppartmentForSaleView> {
  @override
  void dispose() {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
        create: (BuildContext context) => AppartmentForSaleViewModel(),
        child: Scaffold(
          backgroundColor: ColorManager.bgColor,
          resizeToAvoidBottomInset: false,
          body: Consumer<AppartmentForSaleViewModel>(
                        ...
                        children: [
                          for (var element in viewModel.bedroomsQuantity)
                            ChoiceChip(
                              ...
                              elevation: 1,
                              onSelected: (value) {
                                Provider.of<AppartmentForSaleViewModel>(context,
                                        listen: false)
