...
import 'package:oraxproperty/presentation/add_ad_or_req/categories_pages/viewmodel/apartment_for_rent_viewmodel.dart';
...
class AppartmentForRentView extends StatefulWidget {
  const AppartmentForRentView({super.key});

  @override
  State<AppartmentForRentView> createState() => _AppartmentForRentViewState();
}

class _AppartmentForRentViewState extends State<AppartmentForRentView> {
  @override
  void dispose() {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (BuildContext context) => AppartmentForRentViewModel(),
      child: Scaffold(
          backgroundColor: ColorManager.bgColor,
          resizeToAvoidBottomInset: false,
          body: Consumer<AppartmentForRentViewModel>(
                    ...
                    children: [
                      for (var element in viewModel.rentPayPeriod)
                        ChoiceChip(
                          ...
                          elevation: 1,
                          onSelected: (value) {
                            Provider.of<AppartmentForRentViewModel>(context,
                                    listen: false)
