...
import 'package:oraxproperty/presentation/add_ad_or_req/categories_pages/viewmodel/villas_for_sale_viewmodel.dart';
...
class VillasForSaleView extends StatefulWidget {
  const VillasForSaleView({super.key});

  @override
  State<VillasForSaleView> createState() => _VillasForSaleViewState();
}

class _VillasForSaleViewState extends State<VillasForSaleView> {
  @override
  void dispose() {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (BuildContext context) => VillasForSaleViewModel(),
      child: Scaffold(
        backgroundColor: ColorManager.bgColor,
        resizeToAvoidBottomInset: false,
        body: Consumer<VillasForSaleViewModel>(
                        ...
                        children: [
                          for (var element in viewModel.apartmentsQuantity)
                            ChoiceChip(
                              ...
                              elevation: 1,
                              onSelected: (value) {
                                Provider.of<VillasForSaleViewModel>(context,
                                        listen: false)
